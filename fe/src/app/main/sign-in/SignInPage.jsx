...
function SignInPage() {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col items-center sm:flex-row sm:justify-center md:items-start md:justify-start">
      <Paper className="testh-full w-full px-16 py-8 ltr:border-r-1 rtl:border-l-1 sm:h-auto sm:w-auto sm:rounded-2xl sm:p-48 sm:shadow md:flex md:h-full md:w-1/2 md:items-center md:justify-end md:rounded-none md:p-64 md:shadow-none">
        <CardContent className="mx-auto w-full max-w-320 sm:mx-0 sm:w-320">
          ...
          >
            You are browsing <b>Skill criteria in Basket ball</b>. Click on the
            "Sign in" button to access the App.
          </Alert>
        ...
        <div className="relative z-10 w-full max-w-2xl">
          ...
          <div className="mt-32 flex items-center">
            ...
            <div className="ml-16 font-medium tracking-tight text-gray-400">
              More than 17k players joined us, it's your turn
            </div>
          </div>
        </div>
      </Box>
