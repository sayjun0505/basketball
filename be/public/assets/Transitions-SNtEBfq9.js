import{r as c,d as n,j as e,l as d,bh as h,H as i,c4 as f,P as p,cK as I,cM as w,da as y,C as B,er as N,e as T,z as R,h as L,g as P,F as G,T as o,dp as C,bb as E}from"./index-cy1M6gwN.js";import{F as m}from"./FuseExample-0-XNuDGL.js";import{D as z}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{Z as b}from"./Zoom-_cx7dPjB.js";import{d as j}from"./Delete-xi4hnd4s.js";import"./DocumentationNavigation-fvt_Eo8n.js";const x=e(p,{sx:{m:1,width:100,height:100},elevation:4,children:e("svg",{children:e(i,{component:"polygon",points:"0,100 50,00, 100,100",sx:{fill:t=>t.palette.common.white,stroke:t=>t.palette.divider,strokeWidth:1}})})});function O(){const[t,r]=c.useState(!1);return n(i,{sx:{height:300},children:[e(h,{control:e(d,{checked:t,onChange:()=>{r(a=>!a)}}),label:"Show"}),n(i,{sx:{"& > :not(style)":{display:"flex",justifyContent:"space-around",height:120,width:250}},children:[n("div",{children:[e(f,{in:t,children:x}),e(f,{in:t,collapsedSize:40,children:x})]}),n("div",{children:[e(i,{sx:{width:"50%"},children:e(f,{orientation:"horizontal",in:t,children:x})}),e(i,{sx:{width:"50%"},children:e(f,{orientation:"horizontal",in:t,collapsedSize:40,children:x})})]})]})]})}const D=`import * as React from 'react';
...
`,k=e(p,{sx:{m:1,width:100,height:100},elevation:4,children:e("svg",{children:e(i,{component:"polygon",points:"0,100 50,00, 100,100",sx:{fill:t=>t.palette.common.white,stroke:t=>t.palette.divider,strokeWidth:1}})})});function A(){const[t,r]=c.useState(!1);return n(i,{sx:{height:180},children:[e(h,{control:e(d,{checked:t,onChange:()=>{r(a=>!a)}}),label:"Show"}),n(i,{sx:{display:"flex"},children:[e(w,{in:t,children:k}),e(w,{in:t,style:{transformOrigin:"0 0 0"},...t?{timeout:1e3}:{},children:k})]})]})}const U=`import * as React from 'react';
import Box from '@mui/material/Box';
import Switch from '@mui/material/Switch';
import Paper from '@mui/material/Paper';
...
`;function le(t){return n(E,{children:[n("div",{className:"flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between",children:[e(z,{}),e(B,{className:"normal-case",variant:"contained",color:"secondary",component:"a",href:"https://mui.com/components/transitions",target:"_blank",role:"button",size:"small",startIcon:e(G,{size:20,children:"heroicons-outline:external-link"}),children:"Reference"})]}),e(o,{className:"text-32 my-16 font-700",component:"h1",children:"Transitions"}),e(o,{className:"description",children:"Transitions help to make a UI expressive and easy to use."}),n(o,{className:"text-14 mb-32",component:"div",children:["Material UI provides transitions that can be used to introduce some basic ",e("a",{href:"https://m2.material.io/design/motion/",children:"motion"})," to your applications."]}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Collapse"}),n(o,{className:"text-14 mb-32",component:"div",children:["Expand from the start edge of the child element. Use the ",e("code",{children:"orientation"})," prop if you need a horizontal collapse. The ",e("code",{children:"collapsedSize"})," prop can be used to set the minimum width/height when not expanded."]}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SimpleCollapse.js",className:"my-16",iframe:!1,component:O,raw:D})}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Fade"}),e(o,{className:"text-14 mb-32",component:"div",children:"Fade in from transparent to opaque."}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SimpleFade.js",className:"my-16",iframe:!1,component:W,raw:Z})}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Grow"}),e(o,{className:"text-14 mb-32",component:"div",children:"Expands outwards from the center of the child element, while also fading in from transparent to opaque."}),n(o,{className:"text-14 mb-32",component:"div",children:["The second example demonstrates how to change the ",e("code",{children:"transform-origin"}),", and conditionally applies the ",e("code",{children:"timeout"})," prop to change the entry speed."]}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SimpleGrow.js",className:"my-16",iframe:!1,component:A,raw:U})}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Slide"}),n(o,{className:"text-14 mb-32",component:"div",children:["Slide in from the edge of the screen. The ",e("code",{children:"direction"})," prop controls which edge of the screen the transition starts from."]}),n(o,{className:"text-14 mb-32",component:"div",children:["The Transition component's ",e("code",{children:"mountOnEnter"})," prop prevents the child component from being mounted until ",e("code",{children:"in"})," is ",e("code",{children:"true"}),". This prevents the relatively positioned component from scrolling into view from its off-screen position. Similarly, the ",e("code",{children:"unmountOnExit"})," prop removes the component from the DOM after it has been transition off-screen."]}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SimpleSlide.js",className:"my-16",iframe:!1,component:q,raw:$})}),e(o,{className:"text-16 mt-20 mb-10 font-700",component:"h3",children:"Slide relative to a container"}),n(o,{className:"text-14 mb-32",component:"div",children:["The Slide component also accepts ",e("code",{children:"container"})," prop, which is a reference to a DOM node. If this prop is set, the Slide component will slide from the edge of that DOM node."]}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SlideFromContainer.js",className:"my-16",iframe:!1,component:_,raw:K})}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Zoom"}),e(o,{className:"text-14 mb-32",component:"div",children:"Expand outwards from the center of the child element."}),e(o,{className:"text-14 mb-32",component:"div",children:"This example also demonstrates how to delay the enter transition."}),e(o,{className:"text-14 mb-32",component:"div",children:e(m,{name:"SimpleZoom.js",className:"my-16",iframe:!1,component:J,raw:Q})}),e(o,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Child requirement"}),n("ul",{className:"space-y-16",children:[n("li",{children:[e("strong",{children:"Forward the style"}),": To better support server rendering, Material UI provides a ",e("code",{children:"style"})," prop to the children of some transition components (Fade, Grow, Zoom, Slide). The ",e("code",{children:"style"})," prop must be applied to the DOM for the animation to work as expected."]}),n("li",{children:[e("strong",{children:"Forward the ref"}),": The transition components require the first child element to forward its ref to the DOM node. For more details about ref, check out ",e("a",{href:"/material-ui/guides/composition/#caveat-with-refs",children:"Caveat with refs"})]}),n("li",{children:[e("strong",{children:"Single element"}),": The transition components require only one child element (",e("code",{children:"React.Fragment"})," is not allowed)."]})]}),e(C,{component:"pre",className:"language-jsx",children:` 
