import{aF as m,aG as D,aJ as z,d as t,j as e,T as i,x as A,aH as u,bB as h,bN as f,bD as v,aE as G,d1 as b,e5 as V,cZ as y,aI as T,bs as q,br as g,l as H,c5 as Y,bL as j,F as k,_ as E,C as x,bx as U}from"./index-3voNJrtd.js";import{F as W}from"./FuseExample-L3LbvVcu.js";const _=`import { Controller, useForm } from 'react-hook-form';
...
`;let S=0;const J=[{value:"chocolate",label:"Chocolate"},{value:"strawberry",label:"Strawberry"},{value:"vanilla",label:"Vanilla"}],C={Native:"",TextField:"",Select:"",Autocomplete:[],Checkbox:!1,Switch:!1,RadioGroup:"",DateTimePicker:""},O=m.object({TextField:m.string().nonempty("You must enter a value"),Native:m.string().nonempty("You must enter a value"),Select:m.string().nonempty("You must select a value").refine(o=>["20","30"].includes(o),"Select 20 or 30."),Checkbox:m.boolean().refine(o=>o===!0,"You must check."),Switch:m.boolean().refine(o=>o===!0,"You must turn it on."),RadioGroup:m.string().refine(o=>o==="female","You must select female."),Autocomplete:m.array(m.string()).min(2,"Select at least two."),DateTimePicker:m.string().refine(o=>o===null||o.trim().length>0,"You must select a date")});function Z(){var F;const{handleSubmit:o,register:w,reset:I,control:d,watch:R,formState:P}=D({defaultValues:C,mode:"all",resolver:z(O)}),{isValid:N,dirtyFields:L,errors:r,touchedFields:M}=P;S+=1;const B=R();return t("div",{className:"flex w-full max-w-screen-md justify-start items-start",children:[t("form",{className:"w-1/2",onSubmit:o(l=>console.info(l)),children:[t("div",{className:"mt-48 mb-16",children:[e(i,{className:"mb-24 font-medium text-14",children:"Native Input:"}),e("input",{className:A("border-1 outline-none rounded-8 p-8",!!r.Native&&"border-red"),...w("Native"),required:!0}),!!r.Native&&e(i,{className:"px-4 py-8 font-medium text-14",color:"error",children:(F=r==null?void 0:r.Native)==null?void 0:F.message})]}),e("div",{className:"mt-48 mb-16",children:e(u,{name:"Checkbox",control:d,render:({field:{onChange:l,value:a,onBlur:n,ref:p}})=>{var s;return t(h,{error:!!r.Checkbox,required:!0,children:[e(f,{className:"font-medium text-14",component:"legend",children:"MUI Checkbox"}),e(v,{label:"I agree",control:e(G,{checked:a,onBlur:n,onChange:c=>l(c.target.checked),inputRef:p,required:!0})}),e(b,{children:(s=r==null?void 0:r.Checkbox)==null?void 0:s.message})]})}})}),e("div",{className:"mt-48 mb-16",children:e(u,{render:({field:l})=>{var a;return t(h,{error:!!r.RadioGroup,required:!0,children:[e(f,{className:"font-medium text-14",component:"legend",children:"Radio Group"}),t(V,{...l,"aria-label":"gender",name:"gender1",children:[e(v,{value:"female",control:e(y,{}),label:"Female"}),e(v,{value:"male",control:e(y,{}),label:"Male"})]}),e(b,{children:(a=r==null?void 0:r.RadioGroup)==null?void 0:a.message})]})},name:"RadioGroup",control:d})}),e("div",{className:"mt-48 mb-16",children:e(u,{render:({field:l})=>{var a;return e(T,{...l,label:"MUI TextField",variant:"outlined",error:!!r.TextField,helperText:(a=r==null?void 0:r.TextField)==null?void 0:a.message,required:!0,fullWidth:!0})},name:"TextField",control:d})}),e("div",{className:"mt-48 mb-16",children:e(u,{render:({field:l})=>{var a;return t(h,{error:!!r.Select,required:!0,fullWidth:!0,children:[e(f,{className:"font-medium text-14",component:"legend",children:"MUI Select"}),t(q,{...l,variant:"outlined",fullWidth:!0,children:[e(g,{value:"10",children:"Ten (10)"}),e(g,{value:"20",children:"Twenty (20)"}),e(g,{value:"30",children:"Thirty (30)"})]}),e(b,{children:(a=r==null?void 0:r.Select)==null?void 0:a.message})]})},name:"Select",control:d})}),e("div",{className:"mt-48 mb-16",children:e(u,{name:"Switch",control:d,render:({field:{onChange:l,value:a,ref:n,onBlur:p}})=>{var s;return t(h,{required:!0,error:!!r.Switch,children:[e(f,{className:"font-medium text-14",component:"legend",children:"MUI Switch"}),e(H,{checked:a,onBlur:p,onChange:c=>l(c.target.checked),inputRef:n,required:!0}),e(b,{children:(s=r==null?void 0:r.Switch)==null?void 0:s.message})]})}})}),t("div",{className:"mt-48 mb-16",children:[e(i,{className:"mb-24 font-medium text-14",children:"Autocomplete"}),e(u,{name:"Autocomplete",control:d,defaultValue:[],render:({field:{onChange:l,value:a,onBlur:n,ref:p}})=>e(Y,{className:"mt-8 mb-16",multiple:!0,freeSolo:!0,options:J,value:a,onChange:(s,c)=>{l(c)},renderInput:s=>{var c;return e(T,{...s,placeholder:"Select multiple tags",label:"Tags",variant:"outlined",InputLabelProps:{shrink:!0},error:!!r.Autocomplete,helperText:(c=r==null?void 0:r.Autocomplete)==null?void 0:c.message,onBlur:n,inputRef:p})}})})]}),t("div",{className:"mt-48 mb-16",children:[e(i,{className:"mb-24 font-medium text-14",children:"DateTimePicker"}),e(u,{name:"DateTimePicker",control:d,render:({field:{onChange:l,value:a}})=>{var n;return e(j,{value:new Date(a),onChange:l,slotProps:{textField:{id:"birthday",label:"Birthday",InputLabelProps:{shrink:!0},fullWidth:!0,variant:"outlined",error:!!r.DateTimePicker,helperText:(n=r==null?void 0:r.DateTimePicker)==null?void 0:n.message},inputAdornment:{position:"start",children:e(k,{size:20,children:"heroicons-solid:cake"})}}})}})]}),t("div",{className:"flex my-48 items-center",children:[e(x,{className:"mx-8",variant:"contained",color:"secondary",type:"submit",disabled:E.isEmpty(L)||!N,children:"Submit"}),e(x,{className:"mx-8",type:"button",onClick:()=>{I(C)},children:"Reset Form"})]})]}),t("div",{className:"w-1/2 my-48 p-24",children:[e("div",{className:"mb-12",children:t(i,{children:["Is Valid: ",N?"true":"false"]})}),e("div",{className:"mb-12",children:e(i,{children:"Form data"})}),e("div",{className:"mb-12",children:e("pre",{className:"language-js p-24 w-400",children:JSON.stringify(B,null,2)})}),t("div",{className:"mb-12",children:[e(i,{children:"Touched fields"}),e("pre",{className:"language-js p-24 w-400",children:JSON.stringify(M,null,2)})]}),e("div",{className:"mb-12",children:t(i,{className:"mt-16 font-medium text-12 italic",color:"text.secondary",children:["Render Count: ",S]})})]})]})}function X(){return t(U,{children:[t("div",{className:"flex w-full items-center justify-between mb-24",children:[e(i,{variant:"h4",children:"React Hook Form"}),e(x,{variant:"contained",color:"secondary",component:"a",href:"http://react-hook-form.com",target:"_blank",role:"button",startIcon:e(k,{children:"heroicons-outline:external-link"}),children:"Reference"})]}),e(i,{className:"mb-16",component:"p",children:"Performant, flexible and extensible forms with easy to use validation."}),e("hr",{}),e(i,{className:"text-16 mt-32 mb-16",component:"h4",children:"Example usage with Material-UI elements and form validation"}),e(W,{className:"mb-64",component:Z,raw:_}),e(i,{className:"text-32 mt-32 mb-8",component:"h2",children:"Examples"}),t("ul",{children:[e("li",{className:"mb-8",children:"src/app/main/sign-in/SignInPage.tsx"}),e("li",{className:"mb-8",children:"src/app/main/sign-up/SignUpPage.tsx"}),e("li",{className:"mb-8",children:"."}),e("li",{className:"mb-8",children:"."}),e("li",{className:"mb-8",children:"."})]})]})}export{X as default};
