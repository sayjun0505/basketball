import{d as i,j as e,bo as t,cW as o,B as d,ay as u,az as C,ag as f,H as x,s as y,r as D,P as S,F as g,C as w,T as a,bx as N}from"./index-3voNJrtd.js";import{F as n}from"./FuseExample-L3LbvVcu.js";import{D as I}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{d as R}from"./Done-SmsZFwP_.js";import{d as j}from"./Delete-iFJrx99s.js";import"./DocumentationNavigation-us8sikvN.js";function A(){return i(o,{direction:"row",spacing:1,children:[e(t,{label:"Chip Filled"}),e(t,{label:"Chip Outlined",variant:"outlined"})]})}const F=`import * as React from 'react';
...
`;function z(){const l=()=>{console.info("You clicked the Chip.")},c=()=>{console.info("You clicked the delete icon.")};return i(o,{direction:"row",spacing:1,children:[e(t,{label:"Clickable Deletable",onClick:l,onDelete:c}),e(t,{label:"Clickable Deletable",variant:"outlined",onClick:l,onDelete:c})]})}const T=`import * as React from 'react';
import Chip from '@mui/material/Chip';
import Stack from '@mui/material/Stack';
