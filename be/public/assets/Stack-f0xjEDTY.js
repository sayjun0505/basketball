import{s as d,P as c,j as e,d as o,cI as l,H as C,D as B,r as h,bf as u,bt as g,dY as f,bh as r,cL as i,B as N,T as t,F as W,C as D,dp as m,bb as $}from"./index-cy1M6gwN.js";import{F as s}from"./FuseExample-0-XNuDGL.js";import{D as z}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{H}from"./HighlightedCode-fTezzlqK.js";import{G as p}from"./Grid-zsqRuuCl.js";import"./DocumentationNavigation-fvt_Eo8n.js";const y=d(c)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function Y(){return e(C,{sx:{width:"100%"},children:o(l,{spacing:2,children:[e(y,{children:"Item 1"}),e(y,{children:"Item 2"}),e(y,{children:"Item 3"})]})})}const U=`import * as React from 'react';
...
`,k=d(c)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function Z(){return e("div",{children:o(l,{direction:"row",spacing:2,children:[e(k,{children:"Item 1"}),e(k,{children:"Item 2"}),e(k,{children:"Item 3"})]})})}const J=`import * as React from 'react';
import Paper from '@mui/material/Paper';
import Stack from '@mui/material/Stack';
import { styled } from '@mui/material/styles';
const Item = styled(Paper)(({ theme }) => ({
