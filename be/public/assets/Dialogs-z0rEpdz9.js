import{c8 as At,aX as It,bY as Mt,r as v,d,T as m,j as n,C as b,bw as j,e as Pe,bI as J,B as Ge,aj as qe,h as Z,g as Ve,bA as L,bx as Y,by as $,da as Je,ag as Ft,s as Lt,z as Re,O as Oe,N as Ze,D as Et,H as _e,bf as Wt,bg as jt,b6 as Gt,b5 as ae,l as qt,bh as et,K as Vt,cu as Ut,dY as Yt,cL as $t,cK as zt,P as tt,cI as Ue,dZ as Xt,aW as Ht,c1 as ot,bk as nt,bS as Kt,F as Qt,dp as Jt,bb as Zt}from"./index-cy1M6gwN.js";import{F as A}from"./FuseExample-0-XNuDGL.js";import{D as eo}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{d as to}from"./Add-pMJI9iSV.js";import{L as Ye}from"./ListItemAvatar-H5nkMgfX.js";import{D as ee}from"./DialogContentText-N2gVE-GW.js";import{d as at}from"./Close-3McPGxEf.js";import{d as oo}from"./Menu-1TPiZK2Q.js";import{C as no}from"./CssBaseline-NTb4p4Ek.js";import{C as ao}from"./Container-i6Mq7V8z.js";import"./DocumentationNavigation-fvt_Eo8n.js";var Ne={},ro=It;Object.defineProperty(Ne,"__esModule",{value:!0});var rt=Ne.default=void 0,io=ro(At()),lo=Mt;rt=Ne.default=(0,io.default)((0,lo.jsx)("path",{d:"M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4m0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4"}),"Person");const it=["username@gmail.com","user02@gmail.com"];function so(e){const{onClose:t,selectedValue:a,open:o}=e,i=()=>{t(a)},s=g=>{t(g)};return d(L,{onClose:i,open:o,children:[n(j,{children:"Set backup account"}),d(Pe,{sx:{pt:0},children:[it.map(g=>n(Ve,{disableGutters:!0,children:d(J,{onClick:()=>s(g),children:[n(Ye,{children:n(Ge,{sx:{bgcolor:qe[100],color:qe[600]},children:n(rt,{})})}),n(Z,{primary:g})]})},g)),n(Ve,{disableGutters:!0,children:d(J,{autoFocus:!0,onClick:()=>s("addAccount"),children:[n(Ye,{children:n(Ge,{children:n(to,{})})}),n(Z,{primary:"Add account"})]})})]})]})}function co(){const[e,t]=v.useState(!1),[a,o]=v.useState(it[1]);return d("div",{children:[d(m,{variant:"subtitle1",component:"div",children:["Selected: ",a]}),n("br",{}),n(b,{variant:"outlined",onClick:()=>{t(!0)},children:"Open simple dialog"}),n(so,{selectedValue:a,open:e,onClose:g=>{t(!1),o(g)}})]})}const uo=`import * as React from 'react';
...
`;function mo(){const[e,t]=v.useState(!1),a=()=>{t(!0)},o=()=>{t(!1)};return d(v.Fragment,{children:[n(b,{variant:"outlined",onClick:a,children:"Open alert dialog"}),d(L,{open:e,onClose:o,"aria-labelledby":"alert-dialog-title","aria-describedby":"alert-dialog-description",children:[n(j,{id:"alert-dialog-title",children:"Use Google's location service?"}),n(Y,{children:n(ee,{id:"alert-dialog-description",children:"Let Google help apps determine location. This means sending anonymous location data to Google, even when no apps are running."})}),d($,{children:[n(b,{onClick:o,children:"Disagree"}),n(b,{onClick:o,autoFocus:!0,children:"Agree"})]})]})]})}const po=`import * as React from 'react';
import Button from '@mui/material/Button';
import Dialog from '@mui/material/Dialog';
...
`;function vo(){const[e,t]=v.useState(!1),a=()=>{t(!0)},o=()=>{t(!1)};return d(v.Fragment,{children:[n(b,{variant:"outlined",onClick:a,children:"Open form dialog"}),d(L,{open:e,onClose:o,PaperProps:{component:"form",onSubmit:i=>{i.preventDefault();const s=new FormData(i.currentTarget),f=Object.fromEntries(s.entries()).email;console.log(f),o()}},children:[n(j,{children:"Subscribe"}),d(Y,{children:[n(ee,{children:"To subscribe to this website, please enter your email address here. We will send updates occasionally."}),n(Ft,{autoFocus:!0,required:!0,margin:"dense",id:"name",name:"email",label:"Email Address",type:"email",fullWidth:!0,variant:"standard"})]}),d($,{children:[n(b,{onClick:o,children:"Cancel"}),n(b,{type:"submit",children:"Subscribe"})]})]})]})}const yo=`import * as React from 'react';
import Button from '@mui/material/Button';
...
`;function ko(){const[e,t]=v.useState(!1),a=Vt(),o=Ut(a.breakpoints.down("md")),i=()=>{t(!0)},s=()=>{t(!1)};return d(v.Fragment,{children:[n(b,{variant:"outlined",onClick:i,children:"Open responsive dialog"}),d(L,{fullScreen:o,open:e,onClose:s,"aria-labelledby":"responsive-dialog-title",children:[n(j,{id:"responsive-dialog-title",children:"Use Google's location service?"}),n(Y,{children:n(ee,{children:"Let Google help apps determine location. This means sending anonymous location data to Google, even when no apps are running."})}),d($,{children:[n(b,{autoFocus:!0,onClick:s,children:"Disagree"}),n(b,{onClick:s,autoFocus:!0,children:"Agree"})]})]})]})}const Bo=`import * as React from 'react';
import Button from '@mui/material/Button';
import Dialog from '@mui/material/Dialog';
import DialogActions from '@mui/material/DialogActions';
import DialogContent from '@mui/material/DialogContent';
