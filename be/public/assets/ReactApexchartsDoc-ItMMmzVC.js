import{r as s,j as e,d as i,T as o,F as c,C as l,a7 as n,bx as u}from"./index-3voNJrtd.js";import{F as a}from"./FuseExample-L3LbvVcu.js";import{_ as r}from"./react-apexcharts.min-G8Ksigtv.js";function d(){const[t]=s.useState({options:{xaxis:{categories:["Sun","Mon","Tue","Wed","Thu","Fri","Sat","Sun"]}},series:[{name:"series-1",data:[30,40,25,50,49,21,70,51]},{name:"series-2",data:[23,12,54,61,32,56,81,19]}]});return e("div",{className:"area",children:e(r,{options:t.options,series:t.series,type:"area",width:"500"})})}const p=`import Chart from 'react-apexcharts';
