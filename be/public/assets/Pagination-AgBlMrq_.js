import{d as e,j as t,cI as r,c8 as f,aX as P,bY as b,r as d,T as a,s as y,F as S,C as N,dp as R,bb as k}from"./index-cy1M6gwN.js";import{F as o}from"./FuseExample-0-XNuDGL.js";import{D as C}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{P as n,a as I,u as B}from"./Pagination-zljZgFZ0.js";import{T as j}from"./TablePagination-m4YNQdMv.js";import"./DocumentationNavigation-fvt_Eo8n.js";import"./LastPage-YbLXZH-k.js";import"./TableCell-8frVmu-J.js";function T(){return e(r,{spacing:2,children:[t(n,{count:10}),t(n,{count:10,color:"primary"}),t(n,{count:10,color:"secondary"}),t(n,{count:10,disabled:!0})]})}const z=`import * as React from 'react';
...
`;var g={},U=P;Object.defineProperty(g,"__esModule",{value:!0});var v=g.default=void 0,Y=U(f()),H=b;v=g.default=(0,Y.default)((0,H.jsx)("path",{d:"M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20z"}),"ArrowBack");var p={},$=P;Object.defineProperty(p,"__esModule",{value:!0});var x=p.default=void 0,M=$(f()),J=b;x=p.default=(0,M.default)((0,J.jsx)("path",{d:"m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"}),"ArrowForward");function W(){return t(r,{spacing:2,children:t(n,{count:10,renderItem:i=>t(I,{slots:{previous:v,next:x},...i})})})}const X=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
...
`;function K(){return e(r,{spacing:2,children:[t(n,{count:11,defaultPage:6,siblingCount:0}),t(n,{count:11,defaultPage:6})," ",t(n,{count:11,defaultPage:6,siblingCount:0,boundaryCount:2}),t(n,{count:11,defaultPage:6,boundaryCount:2})]})}const G=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
import Stack from '@mui/material/Stack';
