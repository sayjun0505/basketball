...
`;function bt(){const[e,o]=s.useState("recents");return r(L,{sx:{width:500},value:e,onChange:(a,l)=>{o(l)},children:[t(m,{label:"Recents",value:"recents",icon:t(B,{})}),t(m,{label:"Favorites",value:"favorites",icon:t(R,{})}),t(m,{label:"Nearby",value:"nearby",icon:t(_,{})}),t(m,{label:"Folder",value:"folder",icon:t(K,{})})]})}const yt=`import * as React from 'react';
import BottomNavigation from '@mui/material/BottomNavigation';
import BottomNavigationAction from '@mui/material/BottomNavigationAction';
