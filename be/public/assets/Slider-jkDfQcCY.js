import{c8 as b,aX as f,bY as v,r as h,d as r,cI as B,j as e,cO as l,H as o,s as m,al as Z,T as a,A as ee,eh as ae,K as te,z as V,F as re,C as le,dp as ie,bb as oe}from"./index-cy1M6gwN.js";import{F as u}from"./FuseExample-0-XNuDGL.js";import{D as ne}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{G as C}from"./Grid-zsqRuuCl.js";import"./DocumentationNavigation-fvt_Eo8n.js";var R={},ue=f;Object.defineProperty(R,"__esModule",{value:!0});var H=R.default=void 0,se=ue(b()),de=v;H=R.default=(0,se.default)((0,de.jsx)("path",{d:"M18.5 12c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02M5 9v6h4l5 5V4L9 9z"}),"VolumeDown");var D={},ce=f;Object.defineProperty(D,"__esModule",{value:!0});var N=D.default=void 0,me=ce(b()),pe=v;N=D.default=(0,me.default)((0,pe.jsx)("path",{d:"M3 9v6h4l5 5V4L7 9zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02M14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77"}),"VolumeUp");function he(){const[t,i]=h.useState(30);return r(o,{sx:{width:200},children:[r(B,{spacing:2,direction:"row",sx:{mb:1},alignItems:"center",children:[e(H,{}),e(l,{"aria-label":"Volume",value:t,onChange:(c,s)=>{i(s)}}),e(N,{})]}),e(l,{disabled:!0,defaultValue:30,"aria-label":"Disabled slider"})]})}const be=`import * as React from 'react';
...
`,Y=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}];function Re(t){return`${t}°C`}function De(t){return Y.findIndex(i=>i.value===t)+1}function Ne(){return e(o,{sx:{width:300},children:e(l,{"aria-label":"Restricted values",defaultValue:20,valueLabelFormat:De,getAriaValueText:Re,step:null,valueLabelDisplay:"auto",marks:Y})})}const Me=`import * as React from 'react';
import Box from '@mui/material/Box';
import Slider from '@mui/material/Slider';
const marks = [
    {
...
`,Ie=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}];function Le(t){return`${t}°C`}function Ae(){return e(o,{sx:{width:300},children:e(l,{"aria-label":"Always visible",defaultValue:80,getAriaValueText:Le,step:10,marks:Ie,valueLabelDisplay:"on"})})}const $e=`import * as React from 'react';
import Box from '@mui/material/Box';
import Slider from '@mui/material/Slider';
const marks = [
    {
...
`;function Ue(t){return`${t}°C`}function He(){return e(o,{sx:{width:300},children:e(l,{"aria-label":"Temperature",defaultValue:30,getAriaValueText:Ue,color:"secondary"})})}const Ye=`import * as React from 'react';
import Box from '@mui/material/Box';
import Slider from '@mui/material/Slider';
function valuetext(value) {
    return \`\${value}°C\`;
...
`,Ia=m("div")(({theme:t})=>`
  height: ${t.spacing(3)};
`),O=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}];function G(t){return`${t}°C`}function La(){return r(o,{sx:{width:250},children:[e(a,{id:"track-inverted-slider",gutterBottom:!0,children:"Inverted track"}),e(l,{track:"inverted","aria-labelledby":"track-inverted-slider",getAriaValueText:G,defaultValue:30,marks:O}),e(Ia,{}),e(a,{id:"track-inverted-range-slider",gutterBottom:!0,children:"Inverted track range"}),e(l,{track:"inverted","aria-labelledby":"track-inverted-range-slider",getAriaValueText:G,defaultValue:[20,37],marks:O})]})}const Aa=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Box from '@mui/material/Box';
import Typography from '@mui/material/Typography';
import Slider from '@mui/material/Slider';
