import{r as y,j as e,d as t,C as O,dL as L,g as l,b$ as u,i as d,h as c,e as p,D as b,H as f,S as Q,s as w,d5 as R,e7 as ie,T as r,O as v,z as D,N as B,K as E,F as te,dz as z,bx as re}from"./index-3voNJrtd.js";import{F as I}from"./FuseExample-L3LbvVcu.js";import{D as ae}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{d as h}from"./MoveToInbox-seVHVOXE.js";import{d as g}from"./Mail-i9v7vXyE.js";import{C as q}from"./CssBaseline-tT_85EJq.js";import{S as ne}from"./Skeleton-W0F24sv9.js";import{d as N}from"./Menu-qDkrOb0B.js";import{d as F,a as H}from"./ChevronRight-uLRcPFyi.js";import"./DocumentationNavigation-us8sikvN.js";function se(){const[i,a]=y.useState({top:!1,left:!1,bottom:!1,right:!1}),m=(n,s)=>o=>{o.type==="keydown"&&(o.key==="Tab"||o.key==="Shift")||a({...i,[n]:s})},x=n=>t(f,{sx:{width:n==="top"||n==="bottom"?"auto":250},role:"presentation",onClick:m(n,!1),onKeyDown:m(n,!1),children:[e(p,{children:["Inbox","Starred","Send email","Drafts"].map((s,o)=>e(l,{disablePadding:!0,children:t(u,{children:[e(d,{children:o%2===0?e(h,{}):e(g,{})}),e(c,{primary:s})]})},s))}),e(b,{}),e(p,{children:["All mail","Trash","Spam"].map((s,o)=>e(l,{disablePadding:!0,children:t(u,{children:[e(d,{children:o%2===0?e(h,{}):e(g,{})}),e(c,{primary:s})]})},s))})]});return e("div",{children:["left","right","top","bottom"].map(n=>t(y.Fragment,{children:[e(O,{onClick:m(n,!0),children:n}),e(L,{anchor:n,open:i[n],onClose:m(n,!1),children:x(n)})]},n))})}const oe=`import * as React from 'react';
