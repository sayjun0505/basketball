import{s,P as d,j as e,d as i,H as l,r as g,bB as v,bN as w,e5 as C,bD as o,cZ as a,cg as $,T as t,B as R,F as z,C as D,dz as x,bx as H}from"./index-3voNJrtd.js";import{F as m}from"./FuseExample-L3LbvVcu.js";import{D as M}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{G as n}from"./Grid-tp5bxruy.js";import{H as j}from"./HighlightedCode-pqOqf23-.js";import"./DocumentationNavigation-us8sikvN.js";const f=s(d)(({theme:r})=>({backgroundColor:r.palette.mode==="dark"?"#1A2027":"#fff",...r.typography.body2,padding:r.spacing(1),textAlign:"center",color:r.palette.text.secondary}));function J(){return e(l,{sx:{flexGrow:1},children:i(n,{container:!0,spacing:2,children:[e(n,{item:!0,xs:8,children:e(f,{children:"xs=8"})}),e(n,{item:!0,xs:4,children:e(f,{children:"xs=4"})}),e(n,{item:!0,xs:4,children:e(f,{children:"xs=4"})}),e(n,{item:!0,xs:8,children:e(f,{children:"xs=8"})})]})})}const V=`import * as React from 'react';
...
`,y=s(d)(({theme:r})=>({backgroundColor:r.palette.mode==="dark"?"#1A2027":"#fff",...r.typography.body2,padding:r.spacing(1),textAlign:"center",color:r.palette.text.secondary}));function E(){return e(l,{sx:{flexGrow:1},children:i(n,{container:!0,spacing:2,children:[e(n,{item:!0,xs:6,md:8,children:e(y,{children:"xs=6 md=8"})}),e(n,{item:!0,xs:6,md:4,children:e(y,{children:"xs=6 md=4"})}),e(n,{item:!0,xs:6,md:4,children:e(y,{children:"xs=6 md=4"})}),e(n,{item:!0,xs:6,md:8,children:e(y,{children:"xs=6 md=8"})})]})})}const Y=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Box from '@mui/material/Box';
import Paper from '@mui/material/Paper';
import Grid from '@mui/material/Grid';
...
`,b=s(d)(({theme:r})=>({backgroundColor:r.palette.mode==="dark"?"#1A2027":"#fff",...r.typography.body2,padding:r.spacing(1),textAlign:"center",color:r.palette.text.secondary}));function U(){return e(l,{sx:{width:"100%"},children:i(n,{container:!0,rowSpacing:1,columnSpacing:{xs:1,sm:2,md:3},children:[e(n,{item:!0,xs:6,children:e(b,{children:"1"})}),e(n,{item:!0,xs:6,children:e(b,{children:"2"})}),e(n,{item:!0,xs:6,children:e(b,{children:"3"})}),e(n,{item:!0,xs:6,children:e(b,{children:"4"})})]})})}const Z=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Grid from '@mui/material/Grid';
import Paper from '@mui/material/Paper';
import Box from '@mui/material/Box';
...
`;function X(){const[r,h]=g.useState("row"),[u,I]=g.useState("center"),[c,N]=g.useState("center"),L=`
<Grid
  container
  direction="${r}"
  justifyContent="${u}"
