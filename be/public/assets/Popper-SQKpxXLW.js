import{r as m,d as o,j as e,H as g,dU as b,cY as P,P as x,T as t,C as d,F as y,bx as C}from"./index-3voNJrtd.js";import{F as f}from"./FuseExample-L3LbvVcu.js";import{D as k}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{u as B,a as T}from"./react-spring_web.modern-2FUVBg6f.js";import{G as h}from"./Grid-tp5bxruy.js";import{d as E,e as S,P as w}from"./index-WKsFWzC3.js";import"./DocumentationNavigation-us8sikvN.js";function R(){const[r,p]=m.useState(null),i=u=>{p(r?null:u.currentTarget)},s=!!r,c=s?"simple-popper":void 0;return o("div",{children:[e("button",{"aria-describedby":c,type:"button",onClick:i,children:"Toggle Popper"}),e(b,{id:c,open:s,anchorEl:r,children:e(g,{sx:{border:1,p:1,bgcolor:"background.paper"},children:"The content of the Popper."})})]})}const N=`import * as React from 'react';
