import{j as t,z as x,A as o,d as i,C as n,H as f,s as d,ez as c,r as m,T as e,dj as v,cY as y,F as w,dz as u,bx as B}from"./index-3voNJrtd.js";import{F as a}from"./FuseExample-L3LbvVcu.js";import{D as A}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{d as g}from"./Delete-iFJrx99s.js";import{G as s}from"./Grid-tp5bxruy.js";import{Z as C}from"./Zoom-XzNULSg5.js";import"./DocumentationNavigation-us8sikvN.js";function N(){return t(o,{title:"Delete",children:t(x,{children:t(g,{})})})}const R=`import * as React from 'react';
...
`,G=d(({className:l,...r})=>t(o,{...r,classes:{popper:l}}))(({theme:l})=>({[`& .${c.tooltip}`]:{backgroundColor:l.palette.common.white,color:"rgba(0, 0, 0, 0.87)",boxShadow:l.shadows[1],fontSize:11}})),I=d(({className:l,...r})=>t(o,{...r,arrow:!0,classes:{popper:l}}))(({theme:l})=>({[`& .${c.arrow}`]:{color:l.palette.common.black},[`& .${c.tooltip}`]:{backgroundColor:l.palette.common.black}})),j=d(({className:l,...r})=>t(o,{...r,classes:{popper:l}}))(({theme:l})=>({[`& .${c.tooltip}`]:{backgroundColor:"#f5f5f9",color:"rgba(0, 0, 0, 0.87)",maxWidth:220,fontSize:l.typography.pxToRem(12),border:"1px solid #dadde9"}}));function O(){return i("div",{children:[t(G,{title:"Add",children:t(n,{children:"Light"})}),t(I,{title:"Add",children:t(n,{children:"Bootstrap"})}),t(j,{title:i(m.Fragment,{children:[t(e,{color:"inherit",children:"Tooltip with HTML"}),t("em",{children:"And here's"})," ",t("b",{children:"some"})," ",t("u",{children:"amazing content"}),"."," ","It's very engaging. Right?"]}),children:t(n,{children:"HTML"})})]})}const W=`import * as React from 'react';
...
`;function P(){return t(o,{title:"Add",slotProps:{popper:{sx:{[`&.${c.popper}[data-popper-placement*="bottom"] .${c.tooltip}`]:{marginTop:"0px"},[`&.${c.popper}[data-popper-placement*="top"] .${c.tooltip}`]:{marginBottom:"0px"},[`&.${c.popper}[data-popper-placement*="right"] .${c.tooltip}`]:{marginLeft:"0px"},[`&.${c.popper}[data-popper-placement*="left"] .${c.tooltip}`]:{marginRight:"0px"}}}},children:t(n,{children:"Margin"})})}const H=`import * as React from 'react';
import Button from '@mui/material/Button';
import Tooltip, { tooltipClasses } from '@mui/material/Tooltip';
...
`,q=d(({className:l,...r})=>t(o,{...r,classes:{popper:l}}))({[`& .${c.tooltip}`]:{maxWidth:500}}),V=d(({className:l,...r})=>t(o,{...r,classes:{popper:l}}))({[`& .${c.tooltip}`]:{maxWidth:"none"}}),h=`
...
`;function nt(){const l=m.useRef({x:0,y:0}),r=m.useRef(null),p=m.useRef(null);return t(o,{title:"Add",placement:"top",arrow:!0,PopperProps:{popperRef:r,anchorEl:{getBoundingClientRect:()=>new DOMRect(l.current.x,p.current.getBoundingClientRect().y,0,0)}},children:t(f,{ref:p,onMouseMove:b=>{l.current={x:b.clientX,y:b.clientY},r.current!=null&&r.current.update()},sx:{bgcolor:"primary.main",color:"primary.contrastText",p:2},children:"Hover"})})}const it=`import * as React from 'react';
import Box from '@mui/material/Box';
import Tooltip from '@mui/material/Tooltip';
