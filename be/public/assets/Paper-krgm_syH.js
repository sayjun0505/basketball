import{d as a,j as e,P as r,H as p,s as m,dC as h,b1 as g,cI as u,F as x,C as v,T as t,dp as c,bb as y}from"./index-cy1M6gwN.js";import{F as o}from"./FuseExample-0-XNuDGL.js";import{D as b}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{G as s}from"./Grid-zsqRuuCl.js";import"./DocumentationNavigation-fvt_Eo8n.js";function P(){return a(p,{sx:{display:"flex",flexWrap:"wrap","& > :not(style)":{m:1,width:128,height:128}},children:[e(r,{elevation:0}),e(r,{}),e(r,{elevation:3})]})}const w=`import * as React from 'react';
...
`,l=m(r)(({theme:n})=>({width:120,height:120,padding:n.spacing(2),...n.typography.body2,textAlign:"center"}));function C(){return a(u,{direction:"row",spacing:2,children:[e(l,{variant:"elevation",children:"default variant"}),e(l,{variant:"outlined",children:"outlined variant"})]})}const q=`import * as React from 'react';
...
`,d=m(r)(({theme:n})=>({width:120,height:120,padding:n.spacing(2),...n.typography.body2,textAlign:"center"}));function B(){return a(u,{direction:"row",spacing:2,children:[e(d,{square:!1,children:"rounded corners"}),e(d,{square:!0,children:"square corners"})]})}const I=`import * as React from 'react';
import Stack from '@mui/material/Stack';
import Paper from '@mui/material/Paper';
import { styled } from '@mui/material/styles';
const DemoPaper = styled(Paper)(({ theme }) => ({
