import{d as t,j as e,H as r,r as i,F as c,C as l,T as n,dz as a,bx as d}from"./index-3voNJrtd.js";import{F as o}from"./FuseExample-L3LbvVcu.js";import{D as h}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{C as m}from"./CssBaseline-tT_85EJq.js";import{C as s}from"./Container-kgZlNfNe.js";import"./DocumentationNavigation-us8sikvN.js";function f(){return t(i.Fragment,{children:[e(m,{}),e(s,{maxWidth:"sm",children:e(r,{sx:{bgcolor:"#cfe8fc",height:"100vh"}})})]})}const p=`import * as React from 'react';
...
`;function x(){return t(i.Fragment,{children:[e(m,{}),e(s,{fixed:!0,children:e(r,{sx:{bgcolor:"#cfe8fc",height:"100vh"}})})]})}const u=`import * as React from 'react';
import CssBaseline from '@mui/material/CssBaseline';
import Box from '@mui/material/Box';
import Container from '@mui/material/Container';
...
<Container maxWidth="sm">
`}),e(n,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Fixed"}),t(n,{className:"text-14 mb-32",component:"div",children:["If you prefer to design for a fixed set of sizes instead of trying to accommodate a fully fluid viewport, you can set the ",e("code",{children:"fixed"})," prop. The max-width matches the min-width of the current breakpoint."]}),e(n,{className:"text-14 mb-32",component:"div",children:e(o,{name:"FixedContainer.js",className:"my-16",iframe:!0,component:x,raw:u})}),e(a,{component:"pre",className:"language-jsx",children:` 
<Container fixed>
`})]})}export{v as default};
