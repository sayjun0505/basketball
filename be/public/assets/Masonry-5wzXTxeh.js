import{b1 as ae,b2 as se,s as p,r as H,cc as ie,ae as re,ac as C,bc as me,ab as ce,ag as q,x as le,ah as de,dX as G,ed as pe,aq as T,dY as j,bF as he,ee as E,P as y,j as t,H as x,d as i,aB as ue,aC as ge,T as o,aD as fe,F as ye,C as xe,bx as be}from"./index-3voNJrtd.js";import{F as g}from"./FuseExample-L3LbvVcu.js";import{D as Me}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{d as ke}from"./ExpandMore-XrZvfZqR.js";import"./DocumentationNavigation-us8sikvN.js";function we(e){return ae("MuiMasonry",e)}se("MuiMasonry",["root"]);const Ce=["children","className","component","columns","spacing","defaultColumns","defaultHeight","defaultSpacing"],f=e=>Number(e.replace("px","")),Be={flexBasis:"100%",width:0,margin:0,padding:0},ve=e=>{const{classes:n}=e;return de({root:["root"]},we,n)},Ne=({ownerState:e,theme:n})=>{let m={width:"100%",display:"flex",flexFlow:"column wrap",alignContent:"flex-start",boxSizing:"border-box","& > *":{boxSizing:"border-box"}};const h={};if(e.isSSR){const s={},a=f(n.spacing(e.defaultSpacing));for(let r=1;r<=e.defaultColumns;r+=1)s[`&:nth-of-type(${e.defaultColumns}n+${r%e.defaultColumns})`]={order:r};return h.height=e.defaultHeight,h.margin=-(a/2),h["& > *"]=C({},m["& > *"],s,{margin:a/2,width:`calc(${(100/e.defaultColumns).toFixed(2)}% - ${a}px)`}),C({},m,h)}const c=G({values:e.spacing,breakpoints:n.breakpoints.values}),B=pe(n);m=T(m,j({theme:n},c,s=>{let a;if(typeof s=="string"&&!Number.isNaN(Number(s))||typeof s=="number"){const r=Number(s);a=E(B,r)}else a=s;return C({margin:`calc(0px - (${a} / 2))`,"& > *":{margin:`calc(${a} / 2)`}},e.maxColumnHeight&&{height:typeof a=="number"?Math.ceil(e.maxColumnHeight+f(a)):`calc(${e.maxColumnHeight}px + ${a})`})}));const l=G({values:e.columns,breakpoints:n.breakpoints.values});return m=T(m,j({theme:n},l,s=>{const r=`${(100/Number(s)).toFixed(2)}%`,v=typeof c=="string"&&!Number.isNaN(Number(c))||typeof c=="number"?E(B,Number(c)):"0px";return{"& > *":{width:`calc(${r} - ${v})`}}})),typeof c=="object"&&(m=T(m,j({theme:n},c,(s,a)=>{if(a){const r=Number(s),v=Object.keys(l).pop(),u=E(B,r);return{"& > *":{width:`calc(${`${(100/(typeof l=="object"?l[a]||l[v]:l)).toFixed(2)}%`} - ${u})`}}}return null}))),m},Re=p("div",{name:"MuiMasonry",slot:"Root",overridesResolver:(e,n)=>[n.root]})(Ne),Se=H.forwardRef(function(n,m){const h=ie({props:n,name:"MuiMasonry"}),{children:c,className:B,component:L="div",columns:l=4,spacing:P=1,defaultColumns:s,defaultHeight:a,defaultSpacing:r}=h,v=re(h,Ce),u=H.useRef(),[$,D]=H.useState(),z=!$&&a&&s!==void 0&&r!==void 0,[X,Y]=H.useState(z?s-1:0),V=C({},h,{spacing:P,columns:l,maxColumnHeight:$,defaultColumns:s,defaultHeight:a,defaultSpacing:r,isSSR:z}),J=ve(V),K=M=>{if(!u.current||!M||M.length===0)return;const d=u.current,R=u.current.firstChild,O=d.clientWidth,W=R.clientWidth;if(O===0||W===0)return;const _=window.getComputedStyle(R),ee=f(_.marginLeft),te=f(_.marginRight),F=Math.round(O/(W+ee+te)),S=new Array(F).fill(0);let N=!1;d.childNodes.forEach(k=>{if(k.nodeType!==Node.ELEMENT_NODE||k.dataset.class==="line-break"||N)return;const A=window.getComputedStyle(k),ne=f(A.marginTop),oe=f(A.marginBottom),U=f(A.height)?Math.ceil(f(A.height))+ne+oe:0;if(U===0){N=!0;return}for(let w=0;w<k.childNodes.length;w+=1){const I=k.childNodes[w];if(I.tagName==="IMG"&&I.clientHeight===0){N=!0;break}}if(!N){const w=S.indexOf(Math.min(...S));S[w]+=U;const I=w+1;k.style.order=I}}),N||he.flushSync(()=>{D(Math.max(...S)),Y(F>0?F-1:0)})};me(()=>{if(typeof ResizeObserver>"u")return;let M;const d=new ResizeObserver(()=>{M=requestAnimationFrame(K)});return u.current&&u.current.childNodes.forEach(R=>{d.observe(R)}),()=>{M&&window.cancelAnimationFrame(M),d&&d.disconnect()}},[l,P,c]);const Q=ce(m,u),Z=new Array(X).fill("").map((M,d)=>q.jsx("span",{"data-class":"line-break",style:C({},Be,{order:d+1})},d));return q.jsxs(Re,C({as:L,className:le(J.root,B),ref:Q,ownerState:V},v,{children:[c,Z]}))}),b=Se,Ae=[150,30,90,70,110,150,130,80,50,90,100,150,30,50,80],Ie=p(y)(({theme:e})=>({backgroundColor:e.palette.mode==="dark"?"#1A2027":"#fff",...e.typography.body2,padding:e.spacing(.5),textAlign:"center",color:e.palette.text.secondary}));function He(){return t(x,{sx:{width:500,minHeight:393},children:t(b,{columns:4,spacing:2,children:Ae.map((e,n)=>t(Ie,{sx:{height:e},children:n+1},n))})})}const Pe=`import * as React from 'react';
...
`,Ye=[150,30,90,70,90,100,150,30,50,80],Je=p(y)(({theme:e})=>({backgroundColor:e.palette.mode==="dark"?"#1A2027":"#fff",...e.typography.body2,padding:e.spacing(.5),textAlign:"center",color:e.palette.text.secondary}));function Ke(){return t(x,{sx:{width:500,minHeight:377},children:t(b,{columns:3,spacing:3,children:Ye.map((e,n)=>t(Je,{sx:{height:e},children:n+1},n))})})}const Qe=`import * as React from 'react';
import Box from '@mui/material/Box';
import { styled } from '@mui/material/styles';
import Paper from '@mui/material/Paper';
import Masonry from '@mui/lab/Masonry';
