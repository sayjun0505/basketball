import{d as o,j as e,F as a,C as i,T as t,dp as n,bb as c}from"./index-cy1M6gwN.js";import{D as l}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import"./DocumentationNavigation-fvt_Eo8n.js";function h(s){return o(c,{children:[o("div",{className:"flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between",children:[e(l,{}),e(i,{className:"normal-case",variant:"contained",color:"secondary",component:"a",href:"https://mui.com/components/css-baseline",target:"_blank",role:"button",size:"small",startIcon:e(a,{size:20,children:"heroicons-outline:external-link"}),children:"Reference"})]}),e(t,{className:"text-32 my-16 font-700",component:"h1",children:"CSS Baseline"}),e(t,{className:"description",children:"The CssBaseline component helps to kickstart an elegant, consistent, and simple baseline to build upon."}),e(t,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Global reset"}),o(t,{className:"text-14 mb-32",component:"div",children:["You might be familiar with ",e("a",{href:"https://github.com/necolas/normalize.css",children:"normalize.css"}),", a collection of HTML element and attribute style-normalizations."]}),e(n,{component:"pre",className:"language-jsx",children:` 
