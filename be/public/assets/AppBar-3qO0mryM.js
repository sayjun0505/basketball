import{bX as re,r as h,bU as oe,j as e,N as f,d as t,z as l,T as o,C as T,O as u,H as c,bh as te,l as ae,dA as ie,bm as v,b5 as y,c8 as H,aX as _,bY as $,A as ne,B as Q,s as B,a_ as M,I as Y,dB as le,D as se,g as ce,bI as V,h as K,e as J,cN as I,d9 as X,P as me,L as P,da as pe,cK as ue,dC as de,b1 as he,cI as ge,F as fe,dp as k,bb as be}from"./index-cy1M6gwN.js";import{F as b}from"./FuseExample-0-XNuDGL.js";import{D as xe}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{d as x}from"./Menu-1TPiZK2Q.js";import{d as q}from"./AccountCircle-cMFAHQuQ.js";import{C as A}from"./Container-i6Mq7V8z.js";import{d as C}from"./Search-UirgntIS.js";import{C as w}from"./CssBaseline-NTb4p4Ek.js";import{d as F}from"./Mail-H8YjYrCw.js";import{d as E}from"./MoreVert-mQ2kCqbl.js";import{d as ye}from"./Add-pMJI9iSV.js";import{L as Be}from"./ListItemAvatar-H5nkMgfX.js";import{d as ve}from"./KeyboardArrowUp-mjgYOk-Y.js";import"./DocumentationNavigation-fvt_Eo8n.js";const we=["getTrigger","target"];function Ie(r,i){const{disableHysteresis:a=!1,threshold:n=100,target:m}=i,g=r.current;return m&&(r.current=m.pageYOffset!==void 0?m.pageYOffset:m.scrollTop),!a&&g!==void 0&&r.current<g?!1:r.current>n}const Me=typeof window<"u"?window:null;function R(r={}){const{getTrigger:i=Ie,target:a=Me}=r,n=re(r,we),m=h.useRef(),[g,p]=h.useState(()=>i(m,n));return h.useEffect(()=>{const s=()=>{p(i(m,oe({target:a},n)))};return s(),a.addEventListener("scroll",s,{passive:!0}),()=>{a.removeEventListener("scroll",s,{passive:!0})}},[a,i,JSON.stringify(n)]),g}function Te(){return e(c,{sx:{flexGrow:1},children:e(f,{position:"static",children:t(u,{children:[e(l,{size:"large",edge:"start",color:"inherit","aria-label":"menu",sx:{mr:2},children:e(x,{})}),e(o,{variant:"h6",component:"div",sx:{flexGrow:1},children:"News"}),e(T,{color:"inherit",children:"Login"})]})})})}const Ae=`import * as React from 'react';
