import{r as m,d as n,j as e,C as v,bm as f,b5 as i,c8 as I,aX as x,bY as b,i as h,h as p,T as t,D as C,dW as y,P as k,bI as V,e as Y,cM as G,d8 as K,dK as X,cI as U,H as Q,z as B,B as P,A as J,s as Z,a_ as ee,e3 as te,cK as ne,F as oe,bb as ie}from"./index-cy1M6gwN.js";import{F as u}from"./FuseExample-0-XNuDGL.js";import{D as ae}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{d as re,a as le}from"./MoreHoriz-qBYFqucC.js";import{d as ce}from"./Check-wMKn8xyS.js";import{d as se}from"./Settings-hzY32JZb.js";import{d as me}from"./Edit-7SYRS06s.js";import{d as ue}from"./Archive-ISGeCuHV.js";import{d as de}from"./MoreVert-mQ2kCqbl.js";import{d as pe}from"./Drafts-0bIP-zfb.js";import{d as he}from"./Send-ZpIX7LCr.js";import{b as fe,a as Me,P as ve}from"./index-AfmIZvGX.js";import"./DocumentationNavigation-fvt_Eo8n.js";function Ie(){const[o,l]=m.useState(null),r=!!o,c=s=>{l(s.currentTarget)},a=()=>{l(null)};return n("div",{children:[e(v,{id:"basic-button","aria-controls":r?"basic-menu":void 0,"aria-haspopup":"true","aria-expanded":r?"true":void 0,onClick:c,children:"Dashboard"}),n(f,{id:"basic-menu",anchorEl:o,open:r,onClose:a,MenuListProps:{"aria-labelledby":"basic-button"},children:[e(i,{onClick:a,children:"Profile"}),e(i,{onClick:a,children:"My account"}),e(i,{onClick:a,children:"Logout"})]})]})}const xe=`import * as React from 'react';
...
`,z=["Show some love to MUI","Show all notification content","Hide sensitive notification content","Hide all notification content"];function Ne(){const[o,l]=m.useState(null),[r,c]=m.useState(1),a=!!o,s=M=>{l(M.currentTarget)},L=(M,g)=>{c(g),l(null)},d=()=>{l(null)};return n("div",{children:[e(Y,{component:"nav","aria-label":"Device settings",sx:{bgcolor:"background.paper"},children:e(V,{id:"lock-button","aria-haspopup":"listbox","aria-controls":"lock-menu","aria-label":"when device is locked","aria-expanded":a?"true":void 0,onClick:s,children:e(p,{primary:"When device is locked",secondary:z[r]})})}),e(f,{id:"lock-menu",anchorEl:o,open:a,onClose:d,MenuListProps:{"aria-labelledby":"lock-button",role:"listbox"},children:z.map((M,g)=>e(i,{disabled:g===0,selected:g===r,onClick:W=>L(W,g),children:M},M))})]})}const ze=`import * as React from 'react';
...
`;function _e(){const[o,l]=m.useState(!1),r=m.useRef(null),c=()=>{l(d=>!d)},a=d=>{r.current&&r.current.contains(d.target)||l(!1)};function s(d){d.key==="Tab"?(d.preventDefault(),l(!1)):d.key==="Escape"&&l(!1)}const L=m.useRef(o);return m.useEffect(()=>{L.current===!0&&o===!1&&r.current.focus(),L.current=o},[o]),n(U,{direction:"row",spacing:2,children:[e(k,{children:n(y,{children:[e(i,{children:"Profile"}),e(i,{children:"My account"}),e(i,{children:"Logout"})]})}),n("div",{children:[e(v,{ref:r,id:"composition-button","aria-controls":o?"composition-menu":void 0,"aria-expanded":o?"true":void 0,"aria-haspopup":"true",onClick:c,children:"Dashboard"}),e(X,{open:o,anchorEl:r.current,role:void 0,placement:"bottom-start",transition:!0,disablePortal:!0,children:({TransitionProps:d,placement:M})=>e(G,{...d,style:{transformOrigin:M==="bottom-start"?"left top":"left bottom"},children:e(k,{children:e(K,{onClickAway:a,children:n(y,{autoFocusItem:o,id:"composition-menu","aria-labelledby":"composition-button",onKeyDown:s,children:[e(i,{onClick:a,children:"Profile"}),e(i,{onClick:a,children:"My account"}),e(i,{onClick:a,children:"Logout"})]})})})})})]})]})}const je=`import * as React from 'react';
import Button from '@mui/material/Button';
...
`;var N={},ot=x;Object.defineProperty(N,"__esModule",{value:!0});var q=N.default=void 0,it=ot(I()),D=b;q=N.default=(0,it.default)([(0,D.jsx)("circle",{cx:"12",cy:"19",r:"2"},"0"),(0,D.jsx)("path",{d:"M10 3h4v12h-4z"},"1")],"PriorityHigh");function at(){return e(k,{sx:{width:230},children:n(y,{children:[n(i,{children:[e(h,{children:e(he,{fontSize:"small"})}),e(t,{variant:"inherit",children:"A short message"})]}),n(i,{children:[e(h,{children:e(q,{fontSize:"small"})}),e(t,{variant:"inherit",children:"A very long text that overflows"})]}),n(i,{children:[e(h,{children:e(pe,{fontSize:"small"})}),e(t,{variant:"inherit",noWrap:!0,children:"A very long text that overflows"})]})]})})}const rt=`import * as React from 'react';
import MenuList from '@mui/material/MenuList';
import MenuItem from '@mui/material/MenuItem';
import Paper from '@mui/material/Paper';
import ListItemIcon from '@mui/material/ListItemIcon';
