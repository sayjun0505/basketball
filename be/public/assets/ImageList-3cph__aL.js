import{aE as T,aF as j,s as H,bU as c,r as f,bW as z,bX as M,bY as b,x as _,az as R,j as t,H as v,c8 as F,aX as P,d as n,L as W,z as k,F as K,C as q,T as a,bb as E}from"./index-cy1M6gwN.js";import{F as l}from"./FuseExample-0-XNuDGL.js";import{D as Q}from"./DocumentationPageBreadcrumb-0mbWZbHe.js";import{b as Y,I as m,a as u}from"./ImageListItemBar-e5fvY2wN.js";import{d as U}from"./StarBorder-pqZUOuh7.js";import"./DocumentationNavigation-fvt_Eo8n.js";function A(e){return T("MuiImageList",e)}j("MuiImageList",["root","masonry","quilted","standard","woven"]);const J=["children","className","cols","component","rowHeight","gap","style","variant"],O=e=>{const{classes:s,variant:o}=e;return R({root:["root",o]},A,s)},V=H("ul",{name:"MuiImageList",slot:"Root",overridesResolver:(e,s)=>{const{ownerState:o}=e;return[s.root,s[o.variant]]}})(({ownerState:e})=>c({display:"grid",overflowY:"auto",listStyle:"none",padding:0,WebkitOverflowScrolling:"touch"},e.variant==="masonry"&&{display:"block"})),X=f.forwardRef(function(s,o){const i=z({props:s,name:"MuiImageList"}),{children:g,className:C,cols:w=2,component:L="ul",rowHeight:d="auto",gap:r=4,style:x,variant:p="standard"}=i,$=M(i,J),D=f.useMemo(()=>({rowHeight:d,gap:r,variant:p}),[d,r,p]);f.useEffect(()=>{},[]);const N=p==="masonry"?c({columnCount:w,columnGap:r},x):c({gridTemplateColumns:`repeat(${w}, 1fr)`,gap:r},x),B=c({},i,{component:L,gap:r,rowHeight:d,variant:p}),y=O(B);return b.jsx(V,c({as:L,className:_(y.root,y[p],C),ref:o,style:N,ownerState:B},$,{children:b.jsx(Y.Provider,{value:D,children:g})}))}),h=X;function Z(){return t(h,{sx:{width:500,height:450},cols:3,rowHeight:164,children:G.map(e=>t(m,{children:t("img",{srcSet:`${e.img}?w=164&h=164&fit=crop&auto=format&dpr=2 2x`,src:`${e.img}?w=164&h=164&fit=crop&auto=format`,alt:e.title,loading:"lazy"})},e.img))})}const G=[{img:"https://images.unsplash.com/photo-1551963831-b3b1ca40c98e",title:"Breakfast"},{img:"https://images.unsplash.com/photo-1551782450-a2132b4ba21d",title:"Burger"},{img:"https://images.unsplash.com/photo-1522770179533-24471fcdba45",title:"Camera"},{img:"https://images.unsplash.com/photo-1444418776041-9c7e33cc5a9c",title:"Coffee"},{img:"https://images.unsplash.com/photo-1533827432537-70133748f5c8",title:"Hats"},{img:"https://images.unsplash.com/photo-1558642452-9d2a7deb7f62",title:"Honey"},{img:"https://images.unsplash.com/photo-1516802273409-68526ee1bdd6",title:"Basketball"},{img:"https://images.unsplash.com/photo-1518756131217-31eb79b20e8f",title:"Fern"},{img:"https://images.unsplash.com/photo-1597645587822-e99fa5d45d25",title:"Mushrooms"},{img:"https://images.unsplash.com/photo-1567306301408-9b74779a11af",title:"Tomato basil"},{img:"https://images.unsplash.com/photo-1471357674240-e1a485acb3e1",title:"Sea star"},{img:"https://images.unsplash.com/photo-1589118949245-7d38baf380d6",title:"Bike"}],tt=`import * as React from 'react';
...
`;function Ht(e){return n(E,{children:[n("div",{className:"flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between",children:[t(Q,{}),t(q,{className:"normal-case",variant:"contained",color:"secondary",component:"a",href:"https://mui.com/components/image-list",target:"_blank",role:"button",size:"small",startIcon:t(K,{size:20,children:"heroicons-outline:external-link"}),children:"Reference"})]}),t(a,{className:"text-32 my-16 font-700",component:"h1",children:"Image List"}),t(a,{className:"description",children:"The Image List displays a collection of images in an organized grid."}),t(a,{className:"text-14 mb-32",component:"div",children:"Image lists represent a collection of items in a repeated pattern. They help improve the visual comprehension of the content they hold."}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Standard image list"}),t(a,{className:"text-14 mb-32",component:"div",children:"Standard image lists are best for items of equal importance. They have a uniform container size, ratio, and spacing."}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"StandardImageList.js",className:"my-16",iframe:!1,component:Z,raw:tt})}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Quilted image list"}),t(a,{className:"text-14 mb-32",component:"div",children:"Quilted image lists emphasize certain items over others in a collection. They create hierarchy using varied container sizes and ratios."}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"QuiltedImageList.js",className:"my-16",iframe:!1,component:at,raw:ot})}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Woven image list"}),t(a,{className:"text-14 mb-32",component:"div",children:"Woven image lists use alternating container ratios to create a rhythmic layout. A woven image list is best for browsing peer content."}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"WovenImageList.js",className:"my-16",iframe:!1,component:it,raw:mt})}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Masonry image list"}),t(a,{className:"text-14 mb-32",component:"div",children:"Masonry image lists use dynamically sized container heights that reflect the aspect ratio of each image. This image list is best used for browsing uncropped peer content."}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"MasonryImageList.js",className:"my-16",iframe:!1,component:lt,raw:rt})}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Image list with title bars"}),n(a,{className:"text-14 mb-32",component:"div",children:["This example demonstrates the use of the ",t("code",{children:"ImageListItemBar"})," to add an overlay to each item. The overlay can accommodate a ",t("code",{children:"title"}),", ",t("code",{children:"subtitle"})," and secondary action - in this example an ",t("code",{children:"IconButton"}),"."]}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"TitlebarImageList.js",className:"my-16",iframe:!1,component:ut,raw:ft})}),t(a,{className:"text-16 mt-20 mb-10 font-700",component:"h3",children:"Title bar below image (standard)"}),t(a,{className:"text-14 mb-32",component:"div",children:"The title bar can be placed below the image."}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"TitlebarBelowImageList.js",className:"my-16",iframe:!1,component:bt,raw:wt})}),t(a,{className:"text-16 mt-20 mb-10 font-700",component:"h3",children:"Title bar below image (masonry)"}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"TitlebarBelowMasonryImageList.js",className:"my-16",iframe:!1,component:Lt,raw:Bt})}),t(a,{className:"text-24 mt-24 mb-10 font-700",component:"h2",children:"Custom image list"}),n(a,{className:"text-14 mb-32",component:"div",children:["In this example the items have a customized titlebar, positioned at the top and with a custom gradient ",t("code",{children:"titleBackground"}),". The secondary action ",t("code",{children:"IconButton"})," is positioned on the left. The ",t("code",{children:"gap"})," prop is used to adjust the gap between items."]}),t(a,{className:"text-14 mb-32",component:"div",children:t(l,{name:"CustomImageList.js",className:"my-16",iframe:!1,component:vt,raw:St})})]})}export{Ht as default};
