import{r as s,d as a,j as e,C as t,e0 as i,F as l,T as o,bx as m}from"./index-3voNJrtd.js";import{F as d}from"./FuseExample-L3LbvVcu.js";import{D as p}from"./DocumentationPageBreadcrumb-VLGyheWY.js";import{C as h}from"./CircularProgress-OyaDIsfD.js";import"./DocumentationNavigation-us8sikvN.js";function u(){const[r,n]=s.useState(!1);return a("div",{children:[e(t,{onClick:()=>{n(!0)},children:"Show backdrop"}),e(i,{sx:{color:"#fff",zIndex:c=>c.zIndex.drawer+1},open:r,onClick:()=>{n(!1)},children:e(h,{color:"inherit"})})]})}const f=`import * as React from 'react';
