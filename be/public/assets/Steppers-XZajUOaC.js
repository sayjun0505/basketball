...
`,Q=["Select campaign settings","Create an ad group","Create an ad"];function vr(){const[e,t]=_.useState(0),[n,o]=_.useState({}),a=()=>Q.length,i=()=>Object.keys(n).length,l=()=>e===a()-1,u=()=>i()===a(),g=()=>{const b=l()&&!u()?Q.findIndex((B,P)=>!(P in n)):e+1;t(b)},N=()=>{t(b=>b-1)},x=b=>()=>{t(b)},w=()=>{const b=n;b[e]=!0,o(b),g()},I=()=>{t(0),o({})};return f(A,{sx:{width:"100%"},children:[r(D,{nonLinear:!0,activeStep:e,children:Q.map((b,B)=>r(K,{completed:n[B],children:r(ur,{color:"inherit",onClick:x(B),children:b})},b))}),r("div",{children:u()?f(_.Fragment,{children:[r(d,{sx:{mt:2,mb:1},children:"All steps completed - you're finished"}),f(A,{sx:{display:"flex",flexDirection:"row",pt:2},children:[r(A,{sx:{flex:"1 1 auto"}}),r(R,{onClick:I,children:"Reset"})]})]}):f(_.Fragment,{children:[f(d,{sx:{mt:2,mb:1,py:1},children:["Step ",e+1]}),f(A,{sx:{display:"flex",flexDirection:"row",pt:2},children:[r(R,{color:"inherit",disabled:e===0,onClick:N,sx:{mr:1},children:"Back"}),r(A,{sx:{flex:"1 1 auto"}}),r(R,{onClick:g,sx:{mr:1},children:"Next"}),e!==Q.length&&(n[e]?f(d,{variant:"caption",sx:{display:"inline-block"},children:["Step ",e+1," already completed"]}):r(R,{onClick:w,children:i()===a()-1?"Finish":"Complete Step"}))]})]})})]})}const br=`import * as React from 'react';
import Box from '@mui/material/Box';
import Stepper from '@mui/material/Stepper';
import Step from '@mui/material/Step';
